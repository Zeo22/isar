...
namespace ISAR.Controllers
{
    public class UnidadDeMedidaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,Abreviatura")] UnidadDeMedida unidadDeMedida)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,Abreviatura")] UnidadDeMedida unidadDeMedida)
        {
            if (ModelState.IsValid)
            {
